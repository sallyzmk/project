...
public class 게임스타트 {//class 시작
	...
	public static pokemon selectStartPokemon(pokemon myStartingPokemon,pokemon 꼬부기,  pokemon 파이리, pokemon 이상해씨) {
		...
		System.out.print("원하시는 포켓몬의 번호를 입력해 주세요 : ");
		timedelay(500);
		System.out.print("숫자가 아닌 값을 입력하시면 오류가 생깁니다.");
...
//				}
	...
	public static void wildBattle(ArrayList<pokemon> 내포켓몬리스트, ArrayList<pokemon> 속성별리스트){
		...
		System.out.printf("%s를(을) 선택하셨습니다./n",내포켓몬리스트.get(choosepokemon-1).name);
	...
	// [관장전투 함수 시작]
	// 상필 추가
	// 함수 추가 후 맵>case 6에 관장 전투 함수 입력, 앞 뒤 문맥 확인
	// [관장전투 함수 끝]
}//class 끝